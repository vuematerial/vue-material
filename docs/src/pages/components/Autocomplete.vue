          ...
          <div slot="demo">
            <div class="field-group">
              <md-input-container>
                ...
                <md-autocomplete name="movie" id="movie" v-model="movie">
              ...
              <md-input-container>
                ...
                <md-autocomplete name="country" id="country" v-model="country">
              ...
              <md-input-container>
                ...
                <md-autocomplete name="font" id="font" v-model="font">
              ...
              <md-input-container>
                ...
                <md-autocomplete name="food" id="food" v-model="food">
          ...
          <div class="multiple" slot="demo">
            <div class="field-group">
              <md-input-container>
                ...
                <md-autocomplete name="users" id="users" multiple v-model="users">
