<template>
  <page-container centered :title="$t('pages.withRouter.title')">
    <div class="page-container-section">
      ...
      <p>So far the <code><router-link to="/vuematerial/components/tabs">md-tab</router-link></code>, <code><router-link to="/vuematerial/components/list">md-list-item</router-link></code>, <code><router-link to="/vuematerial/components/bottom-bar">md-bottom-bar-item</router-link></code> and <code><router-link to="/vuematerial/components/steppers">md-step</router-link></code> components support Vue router.</p>
