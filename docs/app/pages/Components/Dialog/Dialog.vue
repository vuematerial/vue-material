...
<template>
  <page-container centered :title="$t('pages.dialog.title')">
    <div class="page-container-section">
      ...
      <note-block tip>
        To allow scrolling in content of modal you need to wrap your content in
        <code>md-dialog-content</code> component.
      </note-block>
    </div>
    <div class="page-container-section">
          ...
          props: [
            {
              ...
              type: "Boolean",
              description:
                "The prop to show/hide the dialog. Should be used with the <code>.sync</code> modifier.",
              defaults: "false",
            },
            {
              name: "md-backdrop",
            ...
            },
            {
              ...
              type: "Boolean",
              description:
                "By the default the dialog will close when pressing esc. To disabled that, just set this prop as false",
              defaults: "true",
            },
            {
              ...
              type: "Boolean",
              description:
                "By the default the dialog will close when clicking outsite. To disabled that, just set this prop as false",
              defaults: "true",
            },
            {
              name: "md-fullscreen",
              type: "Boolean",
              description:
                "The dialog will become fullscreen on mobile screens. This option can disable this behavior.",
              defaults: "true",
            },
            {
              name: "md-target",
        ...
        props: {
          ...
          props: [
            ...
            },
            {
              ...
              type: "Number",
              description:
                "Enables the character count, based on the given value.",
              defaults: "null",
            },
            {
