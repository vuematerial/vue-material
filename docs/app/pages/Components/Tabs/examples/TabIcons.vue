<template>
  <div>
    <md-tabs>
      ...
      <md-tab id="tab-posts" md-label="Posts" md-icon="/vuematerial/assets/icon-whatshot.svg"></md-tab>
    ...
    <md-tabs class="md-primary" md-alignment="centered">
      ...
      <md-tab id="tab-posts" md-icon="/vuematerial/assets/icon-whatshot.svg"></md-tab>
