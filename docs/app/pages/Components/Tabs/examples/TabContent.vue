<template>
  <div>
    <md-tabs md-sync-route>
      <md-tab id="tab-home" md-label="Home" to="/vuematerial/components/tabs" exact>
        Home Tab
      </md-tab>
      ...
      <md-tab id="tab-posts" md-label="Posts" to="/vuematerial/components/tabs/posts">
        Posts tab
      ...
      <md-tab id="tab-favorites" md-label="Favorites" to="/vuematerial/components/tabs/favorites">
        Favorites tab
