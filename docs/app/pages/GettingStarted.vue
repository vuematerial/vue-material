<template>
  <page-container centered :title="$t('pages.gettingStarted.title')">
    ...
    <div class="page-container-section">
      ...
      <note-block>Vue Material Documentation assumes that you are confortable with Vue.js 2+. If you are new to Vue.js, it might not be the best idea to learn from here as your first step - grasp the basics then come back. The <a href="https://vuejs.org/v2/guide/index.html">Vue.js website</a> is the greatest documentation source for you start with.</note-block>
    </div>
    ...
    <div class="page-container-section">
      ...
      <note-block alert>Although is not recommended you can use the full bundle of Vue Material. This will import <strong>ALL</strong> components and UI Elements:</note-block>
