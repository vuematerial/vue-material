...
<template>
  <page-container centered :title="$t('pages.layout.title')">
    ...
    <div class="page-container-section">
      <h2>Breakpoints</h2>
      <p>This system makes use of flexbox to be flexible enough and give the best experience with a great and easy API. Vue Material layout uses some breakpoints:</p>
