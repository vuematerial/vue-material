<template>
  <div class="md-select" :class="[themeClass, classes]">
    <md-menu ref="menu" md-align-trigger :md-close-on-select="!multiple" @opened="$emit('open')" @closed="$emit('close')">
      <md-input class="md-select-value" @click.native="toggleMenu" ref="value"></md-input>
      <span md-menu-trigger ref="value" style="display:none;"></span>
